...
Nestle_products = {"KitKat": "34-456-432", "Nescafe": "14-106-132",
                   "Maggi": "9-960-312", "Nido": "44-506-003"}

# Create a variable to hold the values of Unilever products (Use a dictionary)
Unilever_products = {"Lipton": "23-456-000", "Breyers": "1-235-891",
...
'''unilever_nestle = []
for i in (Unilever_products, Nestle_products):
    i = unilever_nestle.union(set(i))
    print(i)'''

#print(set().union(Unilever.keys(), Nestle.keys()))
...
a = {x for x in Unilever if x not in Nestle}
print(a)
c = {x for x in Unilever if x in Nestle}
print(c)
